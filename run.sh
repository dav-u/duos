...
sjc ../src -t ia32 -T nsop -o boot && qemu-system-i386 -m 32 -boot a -fda BOOT_FLP.IMG -machine pcspk-audiodev=snd0 -audiodev pa,id=snd0 -machine pcspk-audiodev=snd0
