...
sjc ../src -t ia32 -T nsop -o boot -u rte -G -g -s 1440k && qemu-system-i386 -m 32 -boot a -fda BOOT_FLP.IMG -device intel-hda -device hda-output -serial file:serial.log